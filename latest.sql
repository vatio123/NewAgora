...
--
-- Host: localhost
-- Generation Time: May 31, 2017 at 01:14 PM
...
('admin', 0, 'admin', 'admin', 'admin@admin.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', 12345),
('anonymous', 0, 'anonymous', 'anonymous', 'not@real.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 0),
('check', 0, 'check', 'check', 'nor@osa@mail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 8038),
('lelmaximo', 0, 'lelmaximo', 'lelmaximo', 'lel@maximo.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 8038),
...
--
ALTER TABLE `answers`
  MODIFY `idanswer` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `questions`
--
ALTER TABLE `questions`
  MODIFY `idquestion` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
--
-- AUTO_INCREMENT for table `reporta`
--
ALTER TABLE `reporta`
  MODIFY `idreporta` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
--
-- AUTO_INCREMENT for table `reportq`
--
ALTER TABLE `reportq`
  MODIFY `idreportq` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT for table `valorationa`
--
ALTER TABLE `valorationa`
  MODIFY `idvalorationa` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `valorationq`
--
ALTER TABLE `valorationq`
  MODIFY `idvalorationq` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
